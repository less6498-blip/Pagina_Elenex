...
<div class="row g-4 mb-4">
  ...
  <div class="col-md-3">
    <div class="stat-card">
      <div style="font-size:13px;color:#888;">Sin Stock</div>
      <div style="font-size:32px;font-weight:700;color:#dc3545;">{{ $stats['sin_stock'] }}</div>
    </div>
  </div>
</div>
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{{ route('admin.productos.editar', $p->id) }}" class="btn btn-outline-dark btn-sm">Editar</a></td>
      </tr>
      @endforeach
    </tbody>
  </table>
